...
plot_AUCHist((survcurv_AUC_vec_MGMT_M_TMZalone-survcurv_AUC_vec_MGMT_M_treat),survcurv_AUC_orig_MGMT_M_TMZalone,'m','A',hist_survcurv_AUC_treat_figcon,hist_survcurv_AUC_treat_fignumb+6,strcat(trat_name,'absolute diff.'))
plot_AUCHist((survcurv_AUC_vec_MGMT_P_TMZalone-survcurv_AUC_vec_MGMT_P_treat),survcurv_AUC_orig_MGMT_P_TMZalone,'p','A',hist_survcurv_AUC_treat_figcon,hist_survcurv_AUC_treat_fignumb+7,strcat(trat_name,'absolute diff.'))
plot_AUCHist((survcurv_AUC_vec_allpat_TMZalone-survcurv_AUC_vec_allpat_treat),survcurv_AUC_orig_MGMT_M_TMZalone,'a','A',hist_survcurv_AUC_treat_figcon,hist_survcurv_AUC_treat_fignumb+8,strcat(trat_name,'absolute diff.'))
...
plot_AUCHist_MGMTtogether_v2((survcurv_AUC_vec_MGMT_M_TMZalone-survcurv_AUC_vec_MGMT_M_treat),(survcurv_AUC_vec_MGMT_P_TMZalone-survcurv_AUC_vec_MGMT_P_treat),'A',hist_survcurv_AUC_treat_figcon,hist_survcurv_AUC_treat_fignumb+10,strcat(trat_name,'absolute diff.'))
