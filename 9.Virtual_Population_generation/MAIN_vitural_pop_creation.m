function MAIN_vitural_pop_creation()

% The following code has for goal to create a virtual population using the
% calibrate PK-PD model and to compute the survival curve AUC of any
% population individual, simulating the application of TMZ alone or with BER and\or
% RI1. The results are saved in the folder "Results" and can be readed
% thanks "vitural_pop_read.m"
