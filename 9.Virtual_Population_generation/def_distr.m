...
k_addO_distr_MGMT_M=pat_log_norm_dist(k_addO,k_addO_var,patient_num);
k_addN_distr_MGMT_M=pat_log_norm_dist(k_addN,k_addN_var,patient_num);
k_CyA_distr_MGMT_M=pat_log_norm_dist(k_CyA,k_CyA_var,patient_num);
K_cdc25_distr_MGMT_M=pat_log_norm_dist(K_cdc25,K_cdc25_var,patient_num);
MGMT0_distr_MGMT_M=MGMT0_U87_LN229*ones(patient_num,1);
k_MGMT_distr_MGMT_M=pat_log_norm_dist(k_MGMT,k_MGMT_var,patient_num);
...
k_DSBO_distr_MGMT_M=pat_log_norm_dist(k_DSBO,k_DSBO_var,patient_num);
k_DSBN_distr_MGMT_M=pat_log_norm_dist(k_DSBN,k_DSBN_var,patient_num);
...
k_ATR_distr_MGMT_M=pat_log_norm_dist(k_ATR,k_ATR_var,patient_num);
K_add_distr_MGMT_M=pat_log_norm_dist(K_add,K_add_var,patient_num);
kd_pATR_distr_MGMT_M=pat_log_norm_dist(kd_pATR,kd_pATR_var,patient_num);%
...
k_Chk1_distr_MGMT_M=pat_log_norm_dist(k_Chk1,k_Chk1_var,patient_num);
kd_pChk1_distr_MGMT_M=pat_log_norm_dist(kd_pChk1,kd_pChk1_var,patient_num);
Cdc250_distr_MGMT_M=pat_log_norm_dist(Cdc250,Cdc250_var,patient_num);
k_cdc25_distr_MGMT_M=pat_log_norm_dist(k_cdc25,k_cdc25_var,patient_num);
kf_p53_distr_MGMT_M=pat_log_norm_dist(kf_p53,kf_p53_var,patient_num);
k_p53_distr_MGMT_M=pat_log_norm_dist(k_p53,k_p53_var,patient_num);
K_ATR_distr_MGMT_M=pat_log_norm_dist(K_ATR,K_ATR_var,patient_num);%
kp_ser46_distr_MGMT_M=pat_log_norm_dist(kp_ser46,kp_ser46_var,patient_num);%
kf_Mdm2_distr_MGMT_M=pat_log_norm_dist(kf_Mdm2,kf_Mdm2_var,patient_num);
K_p53_distr_MGMT_M=pat_log_norm_dist(K_p53,K_p53_var,patient_num);
k_apop_distr_MGMT_M=pat_log_norm_dist(k_apop,k_apop_var,patient_num);
upAsy_distr_MGMT_M=pat_log_norm_dist(upAsy,upAsy_var,patient_num);
tED50_distr_MGMT_M=pat_log_norm_dist(tED50,tED50_var,patient_num);
sness_distr_MGMT_M=pat_log_norm_dist(sness,sness_var,patient_num);
...
k_addO_distr_MGMT_P=pat_log_norm_dist(k_addO,k_addO_var,patient_num);
k_addN_distr_MGMT_P=pat_log_norm_dist(k_addN,k_addN_var,patient_num);
k_CyA_distr_MGMT_P=pat_log_norm_dist(k_CyA,k_CyA_var,patient_num);
K_cdc25_distr_MGMT_P=pat_log_norm_dist(K_cdc25,K_cdc25_var,patient_num);
MGMT0_distr_MGMT_P=pat_log_norm_dist(MGMT_P0,MGMT_P0_var,patient_num);
k_MGMT_distr_MGMT_P=pat_log_norm_dist(k_MGMT,k_MGMT_var,patient_num);
...
k_DSBO_distr_MGMT_P=pat_log_norm_dist(k_DSBO,k_DSBO_var,patient_num);
k_DSBN_distr_MGMT_P=pat_log_norm_dist(k_DSBN,k_DSBN_var,patient_num);
...
kf_ATR_distr_MGMT_P=pat_log_norm_dist(kf_ATR_MGMT_P,kf_ATR_MGMT_P_var,patient_num);
k_ATR_distr_MGMT_P=pat_log_norm_dist(k_ATR,k_ATR_var,patient_num);
K_add_distr_MGMT_P=pat_log_norm_dist(K_add,K_add_var,patient_num);
kd_pATR_distr_MGMT_P=pat_log_norm_dist(kd_pATR,kd_pATR_var,patient_num);%
C_Chk1_distr_MGMT_P=pat_log_norm_dist(C_Chk1,C_Chk1_var,patient_num);
kf_Chk1_distr_MGMT_P=kf_Chk1_MGMT_M*C_Chk1_distr_MGMT_P;
k_Chk1_distr_MGMT_P=pat_log_norm_dist(k_Chk1,k_Chk1_var,patient_num);
kd_pChk1_distr_MGMT_P=pat_log_norm_dist(kd_pChk1,kd_pChk1_var,patient_num);
Cdc250_distr_MGMT_P=pat_log_norm_dist(Cdc250,Cdc250_var,patient_num);
k_cdc25_distr_MGMT_P=pat_log_norm_dist(k_cdc25,k_cdc25_var,patient_num);
kf_p53_distr_MGMT_P=pat_log_norm_dist(kf_p53,kf_p53_var,patient_num);
k_p53_distr_MGMT_P=pat_log_norm_dist(k_p53,k_p53_var,patient_num);
K_ATR_distr_MGMT_P=pat_log_norm_dist(K_ATR,K_ATR_var,patient_num);%
kp_ser46_distr_MGMT_P=pat_log_norm_dist(kp_ser46,kp_ser46_var,patient_num);%
kf_Mdm2_distr_MGMT_P=pat_log_norm_dist(kf_Mdm2,kf_Mdm2_var,patient_num);
K_p53_distr_MGMT_P=pat_log_norm_dist(K_p53,K_p53_var,patient_num);
k_apop_distr_MGMT_P=pat_log_norm_dist(k_apop,k_apop_var,patient_num);
upAsy_distr_MGMT_P=pat_log_norm_dist(upAsy,upAsy_var,patient_num);
tED50_distr_MGMT_P=pat_log_norm_dist(tED50,tED50_var,patient_num);
sness_distr_MGMT_P=pat_log_norm_dist(sness,sness_var,patient_num);
