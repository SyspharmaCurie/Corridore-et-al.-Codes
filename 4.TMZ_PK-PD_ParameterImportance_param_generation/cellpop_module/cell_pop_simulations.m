function [tDMSO_TMZ_pop,norm_popm]=cell_pop_simulations(qqq,patient_indx,h,numb_comptime1,tm_cell,um_cell,N0,k_apop,n_p53int,upAsy,sness,tED50,N_norm0,DMSO_pop,sim_index)

% t=tm_cell{sim_index};
% p53_vec=um_cell{sim_index}(:,21);
[t,p53_vec]=cell_pop_p53vec(qqq,patient_indx,h,numb_comptime1,tm_cell{sim_index},um_cell{sim_index});
