function [TMZout0_surv,surv_curvm] = TMZ_PK_PD_est_V29_2ndstep_p53_IC50_0(patient_indx,patX_param,inhib_factor_BER_Nip,inhib_factor_HR_RI1)
...
%% Cell population 
[surv_curvm,tcellpopm_cell,cellpopm_cell]=simulations_surv_curv(qqq,patient_indx,tm_cell,um_cell,TMZout0_surv,cell_pop0,cell_pop_norm0,k_apop,n_p53int,upAsy,sness,tED50,numb_comptime1);
