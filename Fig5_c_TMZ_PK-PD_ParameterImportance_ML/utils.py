...
def PKPDmodel_sim(Time_data_dir):
  Data_dir="../4.TMZ_PK-PD_ParameterImportance_param_generation/Results/"+Time_data_dir
...
def PKPDmodel_sim_TMZalone(Time_data_dir):
  Data_dir="~/Post-doc/Mathematical_Model (Matlab Code)/TMZ_PK-PD_est_V29_virtpop_V6/Results/"+Time_data_dir
  patient_param_MGMT_M = pd.read_csv(Data_dir+"dataset_MGMT_M.csv")
  patient_param_MGMT_P = pd.read_csv(Data_dir+"dataset_MGMT_P.csv")
