...
%     h2 =histfit(output_vec,NumBins,'kernel')
    ...
    origi_output_y=linspace(0,2.9e4*1.1,100);
    ...
    if MGMT=='m'
        legend('TMZ',treat_legend,strcat('Orig TMZ',fMGMT_orig_MGMT_M))
    elseif MGMT=='p'
       legend('TMZ',treat_legend,strcat('Orig TMZ',fMGMT_orig_MGMT_P))
    elseif MGMT=='a'
