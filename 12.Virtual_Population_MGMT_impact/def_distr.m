...
kf_ATR_distr_MGMT_M= kf_ATR_MGMT_M*ones(patient_num,1); % pat_log_norm_dist(kf_ATR_MGMT_M,kf_ATR_MGMT_M_var,patient_num);%kf_ATR_MGMT_M*ones(patient_num,1);
...
MGMT0_distr_MGMT_P= linspace(0,5*MGMT_P0,patient_num)'; %unifrnd(0,5*MGMT_P0,patient_num,1); %MGMT_P0*ones(patient_num,1); % pat_log_norm_dist(MGMT_P0,MGMT_P0_var,patient_num);
...
kf_ATR_distr_MGMT_P= kf_ATR_MGMT_P*ones(patient_num,1); % pat_log_norm_dist(kf_ATR_MGMT_P,kf_ATR_MGMT_P_var,patient_num);
