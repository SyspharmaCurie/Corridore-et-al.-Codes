function [kf_MGMT_M,kf_MGMT_P,K_cc,DSB_72h,k_addEx,mN370,DSB0,...
...
DSB_72h=DSB_72h_fac*DSB_He_ldTMZ_MGMT_M_72h(1);%0.8*DSB_He_ldTMZ_MGMT_M_72h(1);%Defined observing the fit %(DSB_He_ldTMZ_MGMT_M_72h(1)+DSB_He_ldTMZ_MGMT_P_72h(1))/2;
...
%% ATR inhib initial condition
ATR0_8VX_MGMT_M=0;ATR0_40VX_MGMT_M=0;ATR0_200VX_MGMT_M=0;ATR0_1000VX_MGMT_M=0;
ATR0_8VX_MGMT_P=0;ATR0_40VX_MGMT_P=0;ATR0_200VX_MGMT_P=0;ATR0_1000VX_MGMT_P=0;
VX8_bind=fVX*VX_Jack2D(3);
VX40_bind=fVX*VX_Jack2D(4);
VX200_bind=fVX*VX_Jack2D(5);
VX1000_bind=fVX*VX_Jack2D(6);
if ATR0_MGMT_M-VX8_bind>0
    ATR0_8VX_MGMT_M=ATR0_MGMT_M-VX8_bind;
end
if ATR0_MGMT_M-VX40_bind>0
    ATR0_40VX_MGMT_M=ATR0_MGMT_M-VX40_bind;
end
if ATR0_MGMT_M-VX200_bind>0
    ATR0_200VX_MGMT_M=ATR0_MGMT_M-VX200_bind;
end
if ATR0_MGMT_M-VX1000_bind>0
    ATR0_1000VX_MGMT_M=ATR0_MGMT_M-VX1000_bind;
end

if ATR0_MGMT_P-VX8_bind>0
    ATR0_8VX_MGMT_P=ATR0_MGMT_P-VX8_bind;
end
if ATR0_MGMT_P-VX40_bind>0
    ATR0_40VX_MGMT_P=ATR0_MGMT_P-VX40_bind;
end
if ATR0_MGMT_P-VX200_bind>0
    ATR0_200VX_MGMT_P=ATR0_MGMT_P-VX200_bind;
end
if ATR0_MGMT_P-VX1000_bind>0
    ATR0_1000VX_MGMT_P=ATR0_MGMT_P-VX1000_bind;
end
