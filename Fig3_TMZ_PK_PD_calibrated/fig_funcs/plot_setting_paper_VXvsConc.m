...
%     um_cell{sn_Jack_inhATR_TMZVXcon_MGMT_P} 
    ...
    for n=1:sim_numb
            ...
            MGMT_24h_vec_MGMT_M(n)=Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,9);
            O6meG_tot_24h_vec_MGMT_M(n)=Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,8)+Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,10)+Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,11);
            DSB_24h_vec_MGMT_M(n)=Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,13);
            pATR_24h_vec_MGMT_M(n)=Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,15);
            Chk1_24h_vec_MGMT_M(n)=Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,16);
            pChk1_24h_vec_MGMT_M(n)=Jack_inhATR_MGMT_M_sim(24*numb_comptime1+1,17);
            
            Jack_inhATR_MGMT_P_sim=cell2mat(Jack_inhATR_MGMT_P_sim_cell(n));
            MGMT_24h_vec_MGMT_P(n)=Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,9);
            O6meG_tot_24h_vec_MGMT_P(n)=Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,8)+Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,10)+Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,11);
            DSB_24h_vec_MGMT_P(n)=Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,13);
            pATR_24h_vec_MGMT_P(n)=Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,15);
            Chk1_24h_vec_MGMT_P(n)=Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,16);
            pChk1_24h_vec_MGMT_P(n)=Jack_inhATR_MGMT_P_sim(24*numb_comptime1+1,17);  
     end
