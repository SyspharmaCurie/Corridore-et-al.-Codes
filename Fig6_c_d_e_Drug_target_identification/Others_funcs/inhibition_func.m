function [pT, pT2, k_addO,RNA_MGMT0,MGMT0_U87_LN229,MGMT_P0,kt_MGMT,k_MGMT,kd_MGMT,k_GT,k_MMR,...
    ...
    k_p53,n_ATR,K_ATR,kd_p53,kd_p53Mdm2,n_Mdm2,K_Mdm2,kp_ser46,kt_Mdm2,kt_Mdm2p53,RNA_Mdm20,Mdm20,kf_Mdm2,k_apop,t0_cc,M_cc,A_cc,n_cc, K_cc,omega_cc,phi_cc,K_cdc25,n_cdc25)
...
%% O6meG Adduct formation
k_addO=k_addO*inhib_factor(3);

%% N73meAG Adduct formation
k_addN=k_addN*inhib_factor(4);

%% MGMT-mRNA transcription
