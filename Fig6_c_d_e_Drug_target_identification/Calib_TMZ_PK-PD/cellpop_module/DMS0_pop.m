function [DMSO_pop_MGMT_M,DMSO_pop_MGMT_P] = DMS0_pop()
%% volume in L
Vcell=7*1e-12;
...
[int_cond_mat]= initial_cond_func_DMSOpop(TMZin0,MTICout0,MTICin0,AICout0,AICin0,Cat0,...
...
%% PK-PD Model
[tm_cell,um_cell] = simulations_PKPD_DMSOpop(t_surv,...
    int_cond_mat,...
...
%% Cell population 
[DMSO_t_vec_MGMT_M,DMSO_p53_vec_MGMT_M]=cell_pop_p53vec(144,numb_comptime1,tm_cell{1},um_cell{1});
[DMSO_t_vec_MGMT_P,DMSO_p53_vec_MGMT_P]=cell_pop_p53vec(144,numb_comptime1,tm_cell{2},um_cell{2});
[tDMSO_pop_MGMT_M,DMSO_pop_MGMT_M]=ode23tb(@cell_pop_eq,DMSO_t_vec_MGMT_M,cell_pop0,[],DMSO_t_vec_MGMT_M,DMSO_p53_vec_MGMT_M,k_apop,n_p53int,upAsy,sness,tED50);
[tDMSO_pop_MGMT_P,DMSO_pop_MGMT_P]=ode23tb(@cell_pop_eq,DMSO_t_vec_MGMT_P,cell_pop0,[],DMSO_t_vec_MGMT_P,DMSO_p53_vec_MGMT_P,k_apop,n_p53int,upAsy,sness,tED50);
