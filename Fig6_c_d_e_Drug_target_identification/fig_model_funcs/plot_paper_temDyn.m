...
clf(figure(fig_num));
    ...
    for n=1:sim_numb
        ...
        plot(time,1e3*sim(:,2),plotline(n),'color',color_mat(n,:),'LineWidth',3,'DisplayName', legend_label(n,:));
        hold on
        xlim([-5 xsup])
        ylim([0 3.5e4])
        ...
        subplot(4,4,N37meAG_subplot_numb)
         plot(time,1e3*sim(:,13),plotline(n),'color',color_mat(n,:),'LineWidth',3);
         hold on
         xlim([-5 xsup])
         %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,10),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        % ylim([0 3.9])
        %xlabel('Time (h)','Fontsize',14)
        ...
        box off
         ...
         plot(time,1e3*sim(:,8),plotline(n),'color',color_mat(n,:),'LineWidth',3);
         hold on
         xlim([-10 xsup])
         %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,12),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,14),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,15),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        ylim([0 inf])
        %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,16),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        % ylim([-1 120])
        %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,17),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        ylim([0 inf])
        %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,18),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
         xlim([-1 xsup])
        %xlabel('Time (h)','Fontsize',14)
        ...
        plot(time,1e3*sim(:,20),plotline(n),'color',color_mat(n,:),'LineWidth',3,'DisplayName', legend_label(n,:));
        hold on
        xlim([-1 xsup])
        % ylim([0 3.9])
        xlabel('Time (h)','Fontsize',14)
...
%          legend('fontweight','default','FontSize','default');
        ...
        plot(time,1e3*sim(:,21),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        xlabel('Time (h)','Fontsize',14)
        ...
        hold on
        plot(t_p53_vec,p53_integr_vec,plotline(n),'color',color_mat(n,:),'LineWidth',3)
        xlabel('Time (h)','Fontsize',14)
        ylabel('\int p53');
        set(gca,'fontweight','bold','FontSize',14,'LineWidth',3)
        box off
        ...
        plot(time,1e3*sim(:,19),plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        % ylim([-1 120])
        xlabel('Time (h)','Fontsize',14)
...
%         yyaxis left
        plot(time, CyA,plotline(n),'color',color_mat(n,:),'LineWidth',3);
        hold on
        xlim([-1 xsup])
        ...
        %title('(P)', 'FontSize', 15);
%         yyaxis right
%         plot(time, CyA.^n_cc./(K_cc.^n_cc+CyA.^n_cc),plotline(n),'color',color_mat(n,:),'LineWidth',3);
