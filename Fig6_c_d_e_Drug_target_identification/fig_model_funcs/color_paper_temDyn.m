...
color_rbg_12_5TMZ_MGMT_M = color_conv_an_rgb('#58CCED');
color_rgb_12_5TMZ_MGMT_P = color_conv_an_rgb('#FAC200');
color_rgb_100TMZ_MGMT_M = color_conv_an_rgb('#004999');
color_rgb_100TMZ_MGMT_P = [1 0.0 0.6];
color_rgb_1024TMZ_MGMT_M = color_conv_an_rgb('#1E213D');
color_rgb_1024TMZ_MGMT_P = color_conv_an_rgb('#D83600');
