function MAIN_Virtual_Population_ATR_impact_creation()

% The following code has for goal to analyse the impact of ATR on the
% survival curve AUC, varing ATR production rate and simulating the 
% application of TMZ alone or with BER and\or RI1. The results are saved in
% the folder "Results" and can be read thanks
% "Virtual_Population_ATR_impact_read.m"
...
%% TMZ alone dataset
TMZalone_dataset_dir='Results_2024-04-10_11.43.57_TMZalone';
