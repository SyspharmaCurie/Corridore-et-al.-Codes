function [surv_curvm,tcellpopm_cell,cellpopm_cell]=simulations_surv_curv(tm_cell,um_cell,TMZout0_surv,cell_pop0,cell_pop_norm0,k_apop,n_p53int,upAsy,sness,tED50,numb_comptime1)
...
[DMSO_t_vec,DMSO_p53_vec]=cell_pop_p53vec(144,numb_comptime1,tm_cell{sn_surv_0TMZ_144h},um_cell{sn_surv_0TMZ_144h});
...
for index=sn_surv_0TMZ_144h:sn_surv_3000TMZ_144h
    [tcellpopm_cell{index},cellpopm_cell{index}]=cell_pop_simulations(144,numb_comptime1,tm_cell,um_cell,cell_pop0,k_apop,n_p53int,upAsy,sness,tED50,cell_pop_norm0,DMSO_pop,index);
