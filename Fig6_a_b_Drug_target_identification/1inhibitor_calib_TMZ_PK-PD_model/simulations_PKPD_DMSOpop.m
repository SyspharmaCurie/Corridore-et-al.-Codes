function [tm_cell,um_cell] = simulations_PKPD_DMSOpop(t_surv,...
    int_cond_mat,...
...
%  MGMT-
[tm_cell{1},um_cell{1}]=ode23tb(@TMZ_PK_PD_ODE,t_surv,int_cond_mat(:,1),[],...
    Vin,Vout,pT,pT2,pA,pA2,dna,kcat,kT0,lambdaT,kM0,lambdaM,pH0,...
...
% MGMT+
[tm_cell{2},um_cell{2}]=ode23tb(@TMZ_PK_PD_ODE,t_surv,int_cond_mat(:,2),[],...
    Vin,Vout,pT,pT2,pA,pA2,dna,kcat,kT0,lambdaT,kM0,lambdaM,pH0,...
