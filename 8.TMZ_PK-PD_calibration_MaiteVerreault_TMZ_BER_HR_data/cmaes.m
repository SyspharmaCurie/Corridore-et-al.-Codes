function [xmin, ...      % minimum search point of last iteration
    ...
    forloop_indx, ...    % number indentifing the for loop
...
%  disp(['SEED RELOADED FROM ' opts.SaveFilename]);
  ...
  if irun == 1
    ...
    filenameprefix = [ opts.LogFilenamePrefix num2str(forloop_indx) ];%%%sergio
%     filenameprefix = [ opts.LogFilenamePrefix num2str(forloop_indx) ]%%%original
    if savemodulo 
      filenames = {};
